...
@if ($type === 'responsive')
    ...
    <x-responsive-nav-link :href="route('technieker.flood-forecast.index')" :active="request()->routeIs('technieker.flood-forecast.index')">
        {{ __('Vloed voorspelling') }}
    </x-responsive-nav-link>
@else
    ...
    <x-nav-link :href="route('technieker.flood-forecast.index')" :active="request()->routeIs('technieker.flood-forecast.index')">
        {{ __('Vloed voorspelling') }}
    </x-nav-link>
@endif
