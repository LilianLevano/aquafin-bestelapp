@extends('layouts.app')
@section('title', __('Adres bewerken'))

@section('content')
    <div class="card" style="max-width:560px;margin:0 auto;">
        <h1 class="h1">{{ __('Adres bewerken') }}</h1>
        <form id="edit-form" method="POST" action="{{ route('admin.addresses.update', $address) }}" class="form">
            @csrf @method('PUT')

            <div class="field">
                <label for="type">{{ __('Type') }}</label>
                <input id="type" name="type" value="{{ old('type', $address->type) }}" required
            ...
            <div class="field">
                ...
                <input id="street" name="street" value="{{ old('street', $address->street) }}" required
            ...
            <div class="grid-2">
                <div class="field">
                    ...
                    <input id="house_number" name="house_number" value="{{ old('house_number', $address->house_number) }}" required
                ...
                <div class="field">
                    ...
                    <input id="unit_number" name="unit_number" value="{{ old('unit_number', $address->unit_number) }}"
            ...
            <div class="field">
                ...
                <input id="city" name="city" value="{{ old('city', $address->city) }}" required
            ...
            <div class="field">
                ...
                <input id="postal_code" name="postal_code" value="{{ old('postal_code', $address->postal_code) }}" required
            ...
            <div class="field">
                ...
                <input id="country_iso" name="country_iso" value="{{ old('country_iso', $address->country_iso) }}" required
            ...
            <div class="row-end">
                ...
                <button id="submit-btn" type="submit" class="btn btn-primary">{{ __('Adres bijwerken') }}</button>
            </div>
        </form>
    </div>
@endsection
